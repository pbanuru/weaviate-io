          ...
          <Fade left>
            <div className={styles.leftGrid}>
              ...
              <p className={styles.text}>
                Weaviate is an open-source vector database. It allows you to
                store data objects and vector embeddings from your favorite
                ML-models, and scale seamlessly into billions of data objects.
              </p>
